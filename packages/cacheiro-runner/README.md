...
| --------------------------------- | ------------------------------------- | -------------- |
| `AUTH_TOKEN`                      | `auth.token`                          | `""` (no auth) |
| `PORT`                            | `server.port`                         | `3000`         |
| `HOST`                            | `server.host`                         | `0.0.0.0`      |
| `BODY_LIMIT_MB`                   | `server.bodyLimitMb`                  | `100`          |
| `BANNER`                          | `server.banner`                       | `true`         |
| `INFOBOX`                         | `server.infobox`                      | `true`         |
| `CACHE_STORE`                     | `store.type`                          | `filesystem`   |
| `NX_CACHE_DIRECTORY`              | `store.filesystem.cacheDirectory`     | `./cache`      |
| `CACHE_TTL_DAYS`                  | `store.filesystem.ttlDays`            | `7`            |
| `CACHE_SWEEP_INTERVAL_HOURS`      | `store.filesystem.sweepIntervalHours` | `24`           |
